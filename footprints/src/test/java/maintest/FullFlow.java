...
//		uname = config.getProperty("uname");
	...
	public void AddressDEQC() throws Exception{
		...
		add.addresscheck();
		HashMap<String , String> actual=add.CurrentAddress();
		HashMap<String , String> expected=add.filedata("Current Address");
		HashMap<String , String> Peractual=add.PermanentAdress();
		HashMap<String , String> Perexpected=add.filedata("Permanent");
	...
	public void EmploymentDEQC() throws Exception{
		...
		emp.employmentcheck();
		HashMap<String , String> actual=emp.CurrentEmp();
		HashMap<String , String> expected=emp.filedata("Current/Latest Employment");
		HashMap<String , String> Peractual=emp.PerviousEmp();
		HashMap<String , String> Perexpected=emp.filedata("Previous Employment");
		pages.Utill().SwitchDefault();
		if(actual.equals(expected) && Peractual.equals(Perexpected)) {
			logger.log(Status.PASS, actual.toString());
			logger.log(Status.PASS, Peractual.toString());
	...
	public void ReferenceDEQC() throws Exception{
		...
		ref.referencecheck();
		HashMap<String, String> actual = ref.Referenceone();
		HashMap<String, String> expected = ref.filedata();
		pages.Utill().SwitchDefault();
