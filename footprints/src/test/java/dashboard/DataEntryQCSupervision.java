...
public class DataEntryQCSupervision extends Utill{
	/**
	 * This is class for Data Entry QC Supervision Stage
	 * 
	 * @param logger logger instance
	 */
	public DataEntryQCSupervision(WebDriver driver, ExtentTest logger) {
		super(driver,logger);
	}
	...
	public void assigngetnext(String refno) throws Exception {
		...
		new DataEntryQC(driver,logger).datanentryqc();
		click("btnGetNext");
